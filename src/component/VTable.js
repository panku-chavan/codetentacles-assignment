...
const Table = ({
  ...
  handleRowsPerPageChange: propHandleRowsPerPageChange,
  // Existing props
  cols,
  data,
  totalPages,
  ...
  const rowsPerPage = propRowsPerPage !== undefined 
    ? propRowsPerPage 
    : internalRowsPerPage;
  ...
  const handleChangeRowsPerPage = (event) => {
    ...
    if (propHandleRowsPerPageChange) {
      // Controlled mode: notify parent
      propHandleRowsPerPageChange(value);
    } else {
